...
const privateKey = '0xb857f3cbc74ef044a2e57cbc8696529db47f7f1684c7921f9d432478918ee33c'
const wallet = new ethers.Wallet(privateKey)

const Biconomy = {
  chargeSubscription: async (smartAccountAddress, subscriptionAmountEth, sessionKeyModuleAddress) => {
      ...
      const tx1 = {
        to: await wallet.getAddress(), //erc20 token address
        data: "0x",
        value: ethers.formatEther(subscriptionAmountEth),
      };
